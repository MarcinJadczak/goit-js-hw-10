...
const debounceSearchCountry = _.debounce(searchCountry, 300); 
    ...
    function fetchCountries(country) {
      ...
      countryInfoContainer.innerHTML = `
        ...
        <p>Języki: ${country.languages ? country.languages.join(', ') : 'Brak informacji'}</p>
    ...
    function handleApiResponse(data) {
      ...
      if (Array.isArray(data) && data.length > 0) {
        if (data.length > 10) {
          countryInfoContainer.innerHTML = 'Too many matches found. Please enter a more specific name.';
